...
public class TeacherStaffController {
    TeacherStaffMapper mapper;

    public TeacherStaffController() {
        mapper = new TeacherStaffMapper();
    }

    public TeacherStaffController(String PU) {
        mapper = new TeacherStaffMapper(PU);
    }
